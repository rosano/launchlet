...
describe('LCHCompose_Fund', function () {
	...
	describe('OLSKAppToolbarFundLimit', function test_OLSKAppToolbarFundLimit() {
		...
		it('starts at LCH_FUND_DOCUMENT_LIMIT', function () {
			browser.assert.text('.OLSKAppToolbarFundLimit', process.env.LCH_FUND_DOCUMENT_LIMIT);
		});
		...
		context('create', function () {
			...
			it('updates number', function () {
				browser.assert.text('.OLSKAppToolbarFundLimit', (process.env.LCH_FUND_DOCUMENT_LIMIT - 1).toString());
			});
		...
		context('discard', function () {
			...
			it('updates number', function () {
				browser.assert.text('.OLSKAppToolbarFundLimit', (process.env.LCH_FUND_DOCUMENT_LIMIT - 0).toString());
			});
		...
		context.skip('sync', function () {
			...
			it('updates number', function () {
				browser.assert.elements('.OLSKAppToolbarFundLimit', process.env.LCH_FUND_DOCUMENT_LIMIT - 1);
			});
	...
	describe('clue', function test_clue () {
		...
		describe('OLSKApropos', function test_OLSKApropos() {
			...
			it('sets OLSKAproposFeedbackValue', function () {
				browser.assert.attribute('.OLSKAproposFeedbackButton', 'href', `javascript:window.location.href = window.atob('${ browser.window.btoa('mailto:' + OLSKTestingFormatted(process.env.OLSK_APROPOS_FEEDBACK_EMAIL, 'RP_001+' + clue)) }')`);
			});
